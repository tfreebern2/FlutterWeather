...
class ModelCommand {
  ...
  factory ModelCommand(WeatherRepo repo) {
    ...
    final _updateLocationCommand = RxCommand.createAsync2<LocationResult>(
        repo.updateLocation, canExecute: _getGpsCommand.results);
      
    final _updateWeatherCommand = RxCommand
        .createAsync3<LocationResult, List<WeatherModel>>(
          repo.updateWeather, canExecute: _radioCheckedCommand.results);
